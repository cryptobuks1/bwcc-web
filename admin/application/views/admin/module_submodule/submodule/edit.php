...
<div class="main-content">
	<div class="row gutters">
		<div class="col-md-12">
			<form method="post" action="<?= base_url('cms/module/doupdateSub'); ?>" enctype="multipart/form-data">
				<div class="card">
					<div class="card-header main-head">Sub Module</div>
					<div class="card-body">
						<?php echo flashdata_notif("is_success","Yes"); ?>

						<input type="hidden" name="param" value="<?= encrypt_decrypt('encrypt', $detailSub->submodule_id); ?>">
						...
						<div class="form-group row gutters">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" name="submodule_name" placeholder="Sub Module Name" value="<?= $detailSub->submodule_name ?>"  required="">
							</div>
						</div>
						...
						<div class="form-group row gutters">
							...
							<div class="col-md-10">
								<input type="number" class="form-control" name="order_number_sub" placeholder="Order Number" value="<?= $detailSub->submodule_order ?>" required="">
							</div>
						</div>
						...
						<div class="form-group row gutters">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" name="module_url" placeholder=""  required="" value="<?= $detailSub->submodule_url ?>">
							</div>
						</div>
						<!-- <div class="form-group row gutters">
