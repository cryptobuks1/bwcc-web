		...
		<div class="row">
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
				...
				<div class="page-title">
					<h5>Poli</h5>
					<h6 class="sub-heading">List Poli</h6>
				</div>
			</div>
...
<div class="main-content">
	<div class="row gutters">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header main-head">List Poli</div>
				<div class="card-body">
					<div class="form-group">
						<a href="<?= base_url('cms/poli/add'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
						<!-- Filter :
...
<script type="text/javascript">
	$(document).ready(function() {
		var dataTable = $("#datatable").DataTable({
            ...
            "ajax": {	
                url: "<?php echo base_url('cms/poli/get_list_poli'); ?>", 
                type: "POST",
				data: function (d) {
