...
<div class="main-content">
	...
	<div class="row gutters">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
			<form method="post" action="<?= base_url('cms/privacy/doUpdate'); ?>">
				<input type="hidden" class="form-control" name="param" required="" value="<?= $id ?>">
				<div class="card">
					<div class="card-header main-head">Edit Privacy</div>
					<div class="card-body">
						<?php echo flashdata_notif("is_success","Yes"); ?>
						<div class="form-group row gutters">
							<label class="col-md-2 col-form-label">Isi Privacy & Policy</label>
							<div class="col-md-10">
								<textarea class="form-control" rows="8" name="value"><?= $detailprivacy->value ?></textarea>
							</div>
						</div>
