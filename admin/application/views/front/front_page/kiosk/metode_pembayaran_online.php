				...
				<div class="card-body">
					...
					?>
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-2">
							<a href="<?= base_url('display/getTiketonline/'.$poli->id."/".$id_doctor."/".$getMetode->id."/".$get_req_antrian) ?>" class="btn btn-success btn-lg btn-block"><i class="icon-account_balance_wallet"></i> <?= $getMetode->name ?></a>
						</div>
					<?php
						}
					?>
