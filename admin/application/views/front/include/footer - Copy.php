			...
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget xs-pr-20">
					<a href="index.html" class="xs-footer-logo">
						<img src="<?= base_url() ?>assets/images/logo/logo_kw_white_no_backgound.png" alt="">
					</a>
					<p>Kitawakaf merupakan wadah untuk melakukan wakaf secara online bagi para Wakif serta diperuntukan untuk Nadzir agar bisa membuat campaign wakaf.</p>
